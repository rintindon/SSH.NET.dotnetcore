...
using Renci.SshNetCore.Security.Cryptography.Ciphers;
...
namespace Renci.SshNetCore.Tests.Classes.Security.Cryptography.Ciphers
{
    /// <summary>
    ///
    /// </summary>
    ...
    public class BlowfishCipherTest : TestBase
    {
        ...
        public void Test_Cipher_Blowfish_128_CBC()
        {
            ...
            var testCipher = new Renci.SshNetCore.Security.Cryptography.Ciphers.BlowfishCipher(key, new Renci.SshNetCore.Security.Cryptography.Ciphers.Modes.CbcCipherMode(iv), null);
