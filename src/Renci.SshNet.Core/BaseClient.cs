    ...
    public abstract class BaseClient : IDisposable
    {
        ...
        public TimeSpan KeepAliveInterval
        {
            ...
            set
            {
                ...
                if (value == SshNetCore.Session.InfiniteTimeSpan)
                {
        ...
        /// </summary>
        /// <example>
        ///   <code source="..\..\src\Renci.SshNetCore.Tests\Classes\SshClientTest.cs" region="Example SshClient Connect ErrorOccurred" language="C#" title="Handle ErrorOccurred event" />
        /// </example>
        ...
        /// </summary>
        /// <example>
        ///   <code source="..\..\src\Renci.SshNetCore.Tests\Classes\SshClientTest.cs" region="Example SshClient Connect HostKeyReceived" language="C#" title="Handle HostKeyReceived event" />
        /// </example>
        ...
        internal BaseClient(ConnectionInfo connectionInfo, bool ownsConnectionInfo, IServiceFactory serviceFactory)
        {
            ...
            _keepAliveInterval = SshNetCore.Session.InfiniteTimeSpan;
        }
...
#region IDisposable Members
        ...
        {
            if (_keepAliveInterval == SshNetCore.Session.InfiniteTimeSpan)
                return;
