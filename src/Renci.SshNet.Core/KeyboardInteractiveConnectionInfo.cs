...
namespace Renci.SshNetCore
{
    ...
    /// </summary>
    /// <example>
    ///     <code source="..\..\src\Renci.SshNetCore.Tests\Classes\KeyboardInteractiveConnectionInfoTest.cs" region="Example KeyboardInteractiveConnectionInfo AuthenticationPrompt" language="C#" title="Connect using interactive method" />
    /// </example>
