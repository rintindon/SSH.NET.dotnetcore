...
using Renci.SshNetCore.Compression;
using Renci.SshNetCore.Messages;
...
namespace Renci.SshNetCore
{
    ...
    public class Session : ISession
    {
        ...
        internal Session(ConnectionInfo connectionInfo, IServiceFactory serviceFactory)
        {
            ...
            ClientVersion = "SSH-2.0-Renci.SshNetCore.SshClient.0.0.1";
        ...
        /// <exception cref="SshOperationTimeoutException">The connection failed to establish within the configured <see cref="Renci.SshNetCore.ConnectionInfo.Timeout"/>.</exception>
